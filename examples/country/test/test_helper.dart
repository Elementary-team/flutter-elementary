// ignore_for_file: discarded_futures, lines_longer_than_80_chars
import 'dart:convert';
import 'dart:io';
...
class EntityValueListenableMock<T> extends Mock
    implements EntityValueListenable<T> {}

R provideMockedNetworkImages<R>(R Function() body, {List<int>? imageBytes}) {
  return HttpOverrides.runZoned(
    body,
    createHttpClient: (securityContext) => _createMockImageHttpClient(
        securityContext, imageBytes ?? _transparentImage),
  );
}
