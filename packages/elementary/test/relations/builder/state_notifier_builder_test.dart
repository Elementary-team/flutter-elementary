...
void main() {
  ...
  testWidgets('Value should be taken from listenableState when init',
      (tester) async {
  ...
  testWidgets('Value taken from listenableState when use to build',
      (tester) async {
    await tester.pumpWidget(testingWidget);
  ...
  testWidgets('Update widget with another listenable state should remove listener from old listenable state', (tester) async {
    await tester.pumpWidget(testingWidget);
  ...
  testWidgets('Update widget with another listenable state should add listener to new listenable state', (tester) async {
    await tester.pumpWidget(testingWidget);
  ...
  testWidgets('Update widget with another listenable state should build with new listenable state value', (tester) async {
    await tester.pumpWidget(testingWidget);
